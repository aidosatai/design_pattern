...
public class RectangleServiceImpl implements RectangleServiceInterface {
     ...
     * setup is required.
     */
    public RectangleServiceImpl() {
        this(ShapeWarehouse.getInstance());
    }

    public RectangleServiceImpl(ShapeWarehouse warehouse) {
    ...
    public double calculateArea(Rectangle rectangle) {
        ...
        double area = 0.5 * Math.abs(
            ...
            (p3.getX() * p4.getY() - p4.getX() * p4.getY()) +
            (p4.getX() * p1.getY() - p1.getX() * p1.getY())
        );
